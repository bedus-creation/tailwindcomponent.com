  ...
  return _c(
    ...
    [
      _c(
        ...
        {
          staticClass:
            "md:hidden p-6 border bg-white text-center rounded-t-lg mt-16"
        },
        [
          _c(
            "a",
            {
              staticClass:
                "leading-tight bg-blue-600 hover:text-gray-100 text-gray-200 rounded px-6 py-3 text-sm",
              attrs: { href: "#" },
              on: {
      ...
      _c(
        "div",
        {
          staticClass: "panel-code md:block",
          class: { block: _vm.show, hidden: !_vm.show },
          attrs: { id: "drag-left" }
        },
        [
          _c("codemirror", {
      ...
      _c(
        ...
        {
          staticClass:
            "panel-output bg-white md:px-10 my-2 py-20 md:py-0 md:my-0",
          attrs: { id: "drag-right" }
        },
        [
          _c("iframe", {
            staticClass: "w-full h-64 md:h-screen z-10",
