<div class="bg-white border-b-2 border-red-500 sticky top-0 z-10">
    <nav x-data="{show:false}"
        ...
        <div @click.away="show = false" :class="{ 'block': show, 'hidden': !show }"
            ...
            <div>
                <a href="{{url('/design')}}"
                    class="block md:inline-block font-bold text-base px-0 lg:px-2 py-2 leading-none rounded text-gray-700 mt-2 md:mt-0">Blogs</a>
                <a href="{{url('/design')}}"
                    class="block md:inline-block font-bold text-base px-0 lg:px-3 py-2 leading-none rounded text-gray-700 mt-2 md:mt-0">Design</a>
            </div>
