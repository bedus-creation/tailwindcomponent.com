<div class="bg-white border-b-2 border-red-500 z-10">
    @include('theme.docx.components.laratail')
    <div
        class="container px-8 lg:px-20 mx-auto flex justify-between whitespace-no-wrap overflow-x-auto overflow-y-hidden py-2">
