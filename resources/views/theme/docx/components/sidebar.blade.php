<div class="md:fixed px-8">
    ...
    <ul class="px-1 my-0">
        ...
        <li class="py-1"><a class="leading-relaxed text-gray-600" href="{{url('/component/button')}}">Button</a></li>
        <li class="py-1"><a class="leading-relaxed text-gray-600" href="{{url('/component/list-group')}}">List Group</a>
        </li>
        ...
        <li class="py-1"><a class="leading-relaxed text-gray-600" href="{{url('/component/column')}}">Column</a></li>
        <li class="py-1"><a class="leading-relaxed text-gray-600" href="{{url('/component/form')}}">Form</a></li>
        <li class="py-1"><a class="leading-relaxed text-gray-600" href="{{url('/component/login-form')}}">Login Form</a>
        </li>
    </ul>
</div>
